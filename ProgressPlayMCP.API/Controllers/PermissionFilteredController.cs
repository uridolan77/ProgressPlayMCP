...
public abstract class PermissionFilteredController : BaseController
{
    ...
    protected async Task<List<int>> GetAllowedWhiteLabelIdsAsync()
    {
        ...
        // Add more detailed logging to understand role checking
        ...
        {
            Console.WriteLine("USER IS ADMIN - Returning all WhiteLabels");
    ...
    {
        // This would typically be fetched from a database or service
        // For now, we'll return a placeholder method
        return new List<int> { 276, 277, 278, 279 }; // Example WhiteLabel IDs
    }
